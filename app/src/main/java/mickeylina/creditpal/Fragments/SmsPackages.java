 ...
 * </pre>
 */
public class SmsPackages extends Fragment  {

    public static SmsPackages getInstance(){
        return new SmsPackages(); }
...
//    private ViewPager mViewPager;
    ...
    private SmsPackages.SectionsPagerAdapter mSectionsPagerAdapter;
...
//        PagerAdapter(getChildFragmentManager(), tabLayout.getTabCount());
            mSectionsPagerAdapter = new SmsPackages.SectionsPagerAdapter(getChildFragmentManager());
