...
public class DemoTabView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mCircleDrawable.setBounds(getPaddingLeft(), getPaddingTop(), w - getPaddingRight(),
                h - getPaddingBottom());
    ...
    private void updateIconBounds() {
        if (null != mIconDrawable) {
            ...
            bounds.set(bounds.left + mIconInsetLeft, bounds.top + mIconInsetTop,
                    bounds.right - mIconInsetRight, bounds.bottom - mIconInsetBottom);
